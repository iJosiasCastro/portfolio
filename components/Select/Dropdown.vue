<template>
  <div
    ...
    :class="
      typeof wrapperClass === 'string'
        ? wrapperClass
        : 'relative inline-block text-left cursor-default'
    "
    tabindex="0"
  ...
  >
    ...
    <div
      ...
      ref="tooltip"
      :class="[dropdownClass, mode === 'hover' && 'mt-2']"
      class="z-30 bg-zinc-800/20 backdrop-blur-sm rounded-md"
    >
      <div
      ...
      >
        ...
        <div
          v-if="items.length"
          class="divide-y"
          :class="true ? 'divide-gray-700' : 'divide-gray-100 dark:divide-gray-700'"
        >
