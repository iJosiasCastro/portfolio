export default {
  ...
  experiences: [
    {
      ...
      description: "Colaboré en un equipo de desarrollo para mejorar un producto web. Mi rol incluyó el desarrollo de interfaces de usuario y la implementación de funcionalidades clave. Además, desempeñé un papel activo en procesos de testing y documentación para garantizar la calidad y robustez del código.",
  ...
  main_projects: [
    {
      ...
      link: "https://focomotor.com.ar/",
      description: "Marketplace de vehículos en Argentina que facilita la conexión entre compradores y vendedores, proporcionando interactividad y un sistema de mensajería para una comunicación efectiva entre las partes.",
      stack: [],
    },
    {
      title: "Legajox",
      thumbnail: "legajox_screenshot.jpg",
      link: "https://www.legajox.com/",
      description: "Software de Gestión de Recursos Humanos (RRHH) que controla y administra información de empleados, documentos, días laborables, equipos, áreas, secciones y muchas otras funciones relacionadas.",
      stack: [],
    },
    {
      ...
      description: "Plataforma para un centro de estudiantes que incluye un blog, calendario de eventos, galería de fotos y foro para mantener a la comunidad informada y conectada.",
      stack: [],
    },
    {
      title: "Contabilium",
      ...
      description: "Sistema de gestión y facturación en línea para empresas argentinas. Automatiza procesos administrativos, financieros y de ventas.",
      stack: [],
    },
  ],
  projects_title: "Proyectos | Josías Castro",
  projects: [
    {
      year: "",
      project: "",
  ...
  footer_paragraph:
    '<p>Código desarrollado con <a href="https://nuxt.com/" target="_blank" rel="noreferrer">Nuxt 3</a> y <a href="https://tailwindcss.com/" target="_blank" rel="noreferrer">Tailwind CSS</a> en <a href="https://code.visualstudio.com/" target="_blank" rel="noreferrer">Visual Studio Code</a>, alojado en <a href="https://www.oracle.com/cloud/" target="_blank" rel="noreferrer">Oracle Cloud</a> y protegido por <a href="https://www.cloudflare.com/" target="_blank" rel="noreferrer">Cloudflare</a>, con soporte multilingüe gracias al módulo <a href="https://v8.i18n.nuxtjs.org/" target="_blank" rel="noreferrer">i18n de Nuxt</a>.</p>',
};
